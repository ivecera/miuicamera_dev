...
.method private fillPreference()V
    ...
    const-string v7, "camera_settings_v3_"
    ...
    invoke-virtual {v4, v2}, Lcom/android/camera/data/cloud/DataCloudItemBase;->setReady(Z)V
    ...
    invoke-interface {v4, v2}, Lcom/android/camera/data/cloud/DataCloud$CloudFeature;->setReady(Z)V
...
.method private getCloudSensitiveWords()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/camera/data/cloud/DataCloudMgr;->updateSensitiveWords(ILjava/lang/String;)V
    :try_end_0
