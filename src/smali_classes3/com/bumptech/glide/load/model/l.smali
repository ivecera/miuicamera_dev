...
# static fields
.field private static final Up:Ljava/lang/String; = "@#&=*+-_.,:!?()/~\'%;$"
...
.field private Sp:Ljava/net/URL;
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
.end field

.field private volatile Tp:[B
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Ljava/lang/String;Lcom/bumptech/glide/load/model/n;)V
    ...
    iput-object p1, p0, Lcom/bumptech/glide/load/model/l;->Qp:Ljava/lang/String;
...
.method private Bn()[B
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/model/l;->Tp:[B
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/model/l;->Tp:[B

    :cond_0
    iget-object p0, p0, Lcom/bumptech/glide/load/model/l;->Tp:[B
...
.method private Cn()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/model/l;->Rp:Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/model/l;->Qp:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/model/l;->Rp:Ljava/lang/String;

    :cond_1
    iget-object p0, p0, Lcom/bumptech/glide/load/model/l;->Rp:Ljava/lang/String;

    return-object p0
.end method

.method private Dn()Ljava/net/URL;
    .locals 2
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/model/l;->Sp:Ljava/net/URL;

    if-nez v0, :cond_0

    new-instance v0, Ljava/net/URL;

    invoke-direct {p0}, Lcom/bumptech/glide/load/model/l;->Cn()Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Ljava/net/URL;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lcom/bumptech/glide/load/model/l;->Sp:Ljava/net/URL;

    :cond_0
    iget-object p0, p0, Lcom/bumptech/glide/load/model/l;->Sp:Ljava/net/URL;
...
.method public toURL()Ljava/net/URL;
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/load/model/l;->Dn()Ljava/net/URL;
...
.method public updateDiskCacheKey(Ljava/security/MessageDigest;)V
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/load/model/l;->Bn()[B
