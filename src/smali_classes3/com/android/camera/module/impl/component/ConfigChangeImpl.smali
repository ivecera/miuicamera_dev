...
.method private configGif(I)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/camera/features/mimoji2/widget/helper/MimojiStatusManager2;->setIsGifState(Z)V
    ...
    invoke-interface {v1, p1}, Lcom/android/camera/features/mimoji2/module/protocol/MimojiModeProtocol$MimojiAvatarEngine2;->changeToSquare(Z)V
...
.method private configMacroMode()V
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->c_19039_0x0005_eq_2()Z
    ...
    invoke-virtual {p0, v8}, Lcom/android/camera/module/impl/component/ConfigChangeImpl;->switchOffElementsSilent([I)V
    ...
    invoke-direct {p0, v7}, Lcom/android/camera/module/impl/component/ConfigChangeImpl;->configAIWatermark(I)V

    invoke-static {}, Lcom/android/camera/data/DataRepository;->dataItemRunning()Lcom/android/camera/data/data/runing/DataItemRunning;

    move-result-object v7

    invoke-virtual {v7}, Lcom/android/camera/data/data/runing/DataItemRunning;->getComponentRunningAIWatermark()Lcom/android/camera/data/data/runing/ComponentRunningAIWatermark;

    move-result-object v7

    invoke-virtual {v7, v3}, Lcom/android/camera/data/data/runing/ComponentRunningAIWatermark;->setAIWatermarkEnable(Z)V
    ...
    invoke-virtual {v7}, Lcom/mi/config/a;->c_19039_0x0005_eq_2()Z
    ...
    invoke-direct {p0, v7, v2}, Lcom/android/camera/module/impl/component/ConfigChangeImpl;->setUpdateTipState(IZ)V
    ...
    invoke-virtual {p0}, Lcom/mi/config/a;->c_19039_0x0007()Z
...
.method private configSuperEIS()V
    ...
    invoke-interface {v1, v0, v3}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->alertTopHint(II)V

    const-wide/16 v4, 0xbb8

    invoke-interface {v1, v2, v3, v4, v5}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->alertSwitchHint(IIJ)V
...
.method private configVV()V
    ...
    invoke-virtual {v9}, Lcom/mi/config/a;->xd()Z
...
.method private configVideoQuality()V
    ...
    invoke-static {v3, v2, v5}, Lcom/android/camera/statistic/CameraStatUtils;->trackVideoQuality(Ljava/lang/String;ZLjava/lang/String;)V
...
.method private updateLiveShot(Z)V
    ...
    invoke-virtual {p0}, Lcom/mi/config/a;->c_0x00_s_l_s_IFNOT_global()Z
...
.method public configLiveShotSwitch(I)V
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->c_0x00_s_l_s_IFNOT_global()Z
...
.method public configRawSwitch(I)V
    ...
    invoke-virtual {v1, v0, v6}, Lcom/android/camera/data/data/config/ComponentConfigRaw;->setRaw(IZ)V

    const-string v1, "off"

    invoke-static {v5, p1, v1}, Lcom/android/camera/statistic/MistatsWrapper;->moduleUIClickEvent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    goto :goto_0

    :cond_2
    invoke-virtual {v1, v0, v4}, Lcom/android/camera/data/data/config/ComponentConfigRaw;->setRaw(IZ)V

    invoke-static {}, Lcom/android/camera/data/DataRepository;->dataItemFeature()Lcom/mi/config/a;

    move-result-object v1

    invoke-virtual {v1}, Lcom/mi/config/a;->c_r_i_m_m()Z
    ...
    invoke-virtual {v0, v6}, Lcom/android/camera/module/loader/StartControl;->setNeedReConfigureData(Z)Lcom/android/camera/module/loader/StartControl;
...
.method public configSwitchUltraPixel(I)V
    ...
    invoke-virtual {v10}, Lcom/mi/config/a;->c_r_i_m_m()Z
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/mi/config/a;->c_r_i_m_m()Z
...
.method public reCheckAutoZoom()V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->c_22367_0x0008_OR_0_EQ_1()Z
