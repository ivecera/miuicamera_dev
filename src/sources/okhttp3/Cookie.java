...
public final class Cookie {
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((527 + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + (!this.secure)) * 31) + (!this.httpOnly)) * 31) + (!this.persistent)) * 31) + (!this.hostOnly);
    }
