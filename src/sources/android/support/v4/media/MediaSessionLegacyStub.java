...
class MediaSessionLegacyStub extends MediaSessionCompat.Callback {
    ...
    private void onCommand2Internal(@NonNull IBinder iBinder, @Nullable final SessionCommand2 sessionCommand2, final int i, @NonNull final Session2Runnable session2Runnable) {
        ...
        if (supportLibraryImpl != null && controllerInfo != null) {
            supportLibraryImpl.getCallbackExecutor().execute(new Runnable() {
                ...
                public void run() {
                    ...
                    if (sessionCommand22 != null) {
                        if (MediaSessionLegacyStub.this.isAllowedCommand(controllerInfo, sessionCommand22)) {
                            sessionCommand2 = (SessionCommand2) MediaSessionLegacyStub.sCommandsForOnCommandRequest.get(sessionCommand2.getCommandCode());
                        } else {
                            return;
                        }
                    } else if (MediaSessionLegacyStub.this.isAllowedCommand(controllerInfo, i)) {
                        sessionCommand2 = (SessionCommand2) MediaSessionLegacyStub.sCommandsForOnCommandRequest.get(i);
                    } else {
                        return;
                    }
