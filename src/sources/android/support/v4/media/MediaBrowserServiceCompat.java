...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompatApi23.ServiceCompatProxy {
        ...
        public void onCreate() {
            ((MediaBrowserServiceImplApi21) this).mServiceObj = MediaBrowserServiceCompatApi23.createService(MediaBrowserServiceCompat.this, this);
            MediaBrowserServiceCompatApi21.onCreate(((MediaBrowserServiceImplApi21) this).mServiceObj);
        }
    ...
    class MediaBrowserServiceImplApi26 extends MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi26.ServiceCompatProxy {
        ...
        public Bundle getBrowserRootHints() {
            ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mCurConnection;
            if (connectionRecord == null) {
                return MediaBrowserServiceCompatApi26.getBrowserRootHints(((MediaBrowserServiceImplApi21) this).mServiceObj);
            }
            Bundle bundle = connectionRecord.rootHints;
            if (bundle == null) {
                return null;
        ...
        public void notifyChildrenChangedForFramework(String str, Bundle bundle) {
            if (bundle != null) {
                MediaBrowserServiceCompatApi26.notifyChildrenChanged(((MediaBrowserServiceImplApi21) this).mServiceObj, str, bundle);
            } else {
        ...
        public void onCreate() {
            ((MediaBrowserServiceImplApi21) this).mServiceObj = MediaBrowserServiceCompatApi26.createService(MediaBrowserServiceCompat.this, this);
            MediaBrowserServiceCompatApi21.onCreate(((MediaBrowserServiceImplApi21) this).mServiceObj);
        }
    ...
    class MediaBrowserServiceImplApi28 extends MediaBrowserServiceImplApi26 {
        ...
        public MediaSessionManager.RemoteUserInfo getCurrentBrowserInfo() {
            ...
            MediaSessionManager.RemoteUserInfo currentBrowserInfo = ((MediaBrowserService) ((MediaBrowserServiceImplApi21) this).mServiceObj).getCurrentBrowserInfo();
