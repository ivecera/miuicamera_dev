...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public void registerMediaButtonEventReceiver(PendingIntent pendingIntent, ComponentName componentName) {
            if (sIsMbrPendingIntentSupported) {
                try {
                    ((MediaSessionImplBase) this).mAudioManager.registerMediaButtonEventReceiver(pendingIntent);
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            if (callback == null) {
                ((MediaSessionImplBase) this).mRcc.setPlaybackPositionUpdateListener(null);
                return;
            }
            ((MediaSessionImplBase) this).mRcc.setPlaybackPositionUpdateListener(new RemoteControlClient.OnPlaybackPositionUpdateListener() {
        ...
        public void setRccState(PlaybackStateCompat playbackStateCompat) {
            ...
            ((MediaSessionImplBase) this).mRcc.setPlaybackState(getRccStateFromState(playbackStateCompat.getState()), position, playbackSpeed);
        }
        ...
        public void unregisterMediaButtonEventReceiver(PendingIntent pendingIntent, ComponentName componentName) {
            if (sIsMbrPendingIntentSupported) {
                ((MediaSessionImplBase) this).mAudioManager.unregisterMediaButtonEventReceiver(pendingIntent);
            } else {
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public void setCallback(Callback callback, Handler handler) {
            super.setCallback(callback, handler);
            if (callback == null) {
                ((MediaSessionImplBase) this).mRcc.setMetadataUpdateListener(null);
                return;
            }
            ((MediaSessionImplBase) this).mRcc.setMetadataUpdateListener(new RemoteControlClient.OnMetadataUpdateListener() {
