...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplApi23 extends MediaBrowserImplApi21 {
        ...
        public void getItem(@NonNull String str, @NonNull ItemCallback itemCallback) {
            if (((MediaBrowserImplApi21) this).mServiceBinderWrapper == null) {
                MediaBrowserCompatApi23.getItem(((MediaBrowserImplApi21) this).mBrowserObj, str, itemCallback.mItemCallbackObj);
            } else {
    ...
    static class MediaBrowserImplApi26 extends MediaBrowserImplApi23 {
        ...
        public void subscribe(@NonNull String str, @Nullable Bundle bundle, @NonNull SubscriptionCallback subscriptionCallback) {
            if (((MediaBrowserImplApi21) this).mServiceBinderWrapper != null && ((MediaBrowserImplApi21) this).mServiceVersion >= 2) {
                super.subscribe(str, bundle, subscriptionCallback);
            } else if (bundle == null) {
                MediaBrowserCompatApi21.subscribe(((MediaBrowserImplApi21) this).mBrowserObj, str, subscriptionCallback.mSubscriptionCallbackObj);
            } else {
                MediaBrowserCompatApi26.subscribe(((MediaBrowserImplApi21) this).mBrowserObj, str, bundle, subscriptionCallback.mSubscriptionCallbackObj);
            }
        }
        ...
        public void unsubscribe(@NonNull String str, SubscriptionCallback subscriptionCallback) {
            if (((MediaBrowserImplApi21) this).mServiceBinderWrapper != null && ((MediaBrowserImplApi21) this).mServiceVersion >= 2) {
                ...
                MediaBrowserCompatApi21.unsubscribe(((MediaBrowserImplApi21) this).mBrowserObj, str);
            } else {
                MediaBrowserCompatApi26.unsubscribe(((MediaBrowserImplApi21) this).mBrowserObj, str, subscriptionCallback.mSubscriptionCallbackObj);
            }
        }
    }
