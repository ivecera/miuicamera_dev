...
class MediaController2ImplLegacy implements MediaController2.SupportLibraryImpl {
    ...
    private final class ControllerCompatCallback extends MediaControllerCompat.Callback {
        ...
        public void onSessionReady() {
            ...
            mediaController2ImplLegacy.sendCommand("android.support.v4.media.controller.command.CONNECT", new ResultReceiver(mediaController2ImplLegacy.mHandler) {
    ...
    public long getCurrentPosition() {
        synchronized (this.mLock) {
            if (!this.mConnected) {
                ...
                long max = Math.max(0L, this.mPlaybackStateCompat.getPosition() + ((long) (this.mPlaybackStateCompat.getPlaybackSpeed() * ((float) (this.mInstance.mTimeDiff != null ? this.mInstance.mTimeDiff.longValue() : SystemClock.elapsedRealtime() - this.mPlaybackStateCompat.getLastPositionUpdateTime())))));
                return max;
            }
        }
    }
                ...
                try {
                    if (!this.mIsReleased) {
                        if (this.mConnected) {
                            ...
                            this.mCallbackExecutor.execute(new Runnable() {
                                /* class android.support.v4.media.MediaController2ImplLegacy.AnonymousClass2 */
