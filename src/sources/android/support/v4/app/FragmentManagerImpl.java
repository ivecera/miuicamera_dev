...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    public void moveToState(Fragment fragment, int i, int i2, int i3, boolean z) {
        ...
        if (fragment.mRemoving && i4 > (i7 = fragment.mState)) {
            i4 = (i7 != 0 || !fragment.isInBackStack()) ? fragment.mState : 1;
        }
        int i9 = (!fragment.mDeferStart || fragment.mState >= 4 || i4 <= 3) ? i4 : 3;
        ...
        if (i10 <= i9) {
            if (!fragment.mFromLayout || fragment.mInLayout) {
                ...
                if (i11 != 0) {
                    ...
                    fragment.mFragmentManager = fragment2 != null ? fragment2.mChildFragmentManager : fragmentHostCallback.getFragmentManagerImpl();
                    ...
                    if (fragment3 != null) {
                        ...
                        if (fragment4 != fragment5) {
                            ...
                            if (!fragment.mCalled) {
                                ...
                                throw new SuperNotCalledException(str2 + fragment + " did not call through to super.onAttach()");
                            }
                        }
                    }
                    str2 = "Fragment ";
                ...
                if (i9 > 1) {
                    ...
                    if (!fragment.mFromLayout) {
                        ...
                        if (i12 == 0) {
                            ...
                            viewGroup2 = (ViewGroup) this.mContainer.onFindViewById(i12);
            ...
            if (i10 != 1) {
                ...
                if (i9 < 2) {
                    ...
                    if (!(view2 == null || (viewGroup = fragment.mContainer) == null)) {
                        ...
                        fragment.mPostponedAlpha = 0.0f;
                        if (loadAnimation != null) {
                            animateRemoveFragment(fragment, loadAnimation, i9);
                        }
            ...
            if (i9 < 1) {
                ...
                if (fragment.getAnimatingAway() == null && fragment.getAnimator() == null) {
                    ...
                    if (fragment.mState == i8) {
                        Log.w(TAG, "moveToState: Fragment state for " + fragment + " not updated inline; " + "expected state " + i8 + " found " + fragment.mState);
                        fragment.mState = i8;
                        return;
                    }
                    return;
