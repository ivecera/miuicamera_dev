...
public class NotificationCompat {
    ...
    public static class BigPictureStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (Build.VERSION.SDK_INT >= 16) {
                Notification.BigPictureStyle bigPicture = new Notification.BigPictureStyle(notificationBuilderWithBuilderAccessor.getBuilder()).setBigContentTitle(((Style) this).mBigContentTitle).bigPicture(this.mPicture);
                if (this.mBigLargeIconSet) {
                    bigPicture.bigLargeIcon(this.mBigLargeIcon);
                }
                if (((Style) this).mSummaryTextSet) {
                    bigPicture.setSummaryText(((Style) this).mSummaryText);
                }
            }
        }
        ...
        public BigPictureStyle setBigContentTitle(CharSequence charSequence) {
            ((Style) this).mBigContentTitle = Builder.limitCharSequenceLength(charSequence);
            return this;
        }

        public BigPictureStyle setSummaryText(CharSequence charSequence) {
            ((Style) this).mSummaryText = Builder.limitCharSequenceLength(charSequence);
            ((Style) this).mSummaryTextSet = true;
            return this;
        }
    }
    ...
    public static class BigTextStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (Build.VERSION.SDK_INT >= 16) {
                Notification.BigTextStyle bigText = new Notification.BigTextStyle(notificationBuilderWithBuilderAccessor.getBuilder()).setBigContentTitle(((Style) this).mBigContentTitle).bigText(this.mBigText);
                if (((Style) this).mSummaryTextSet) {
                    bigText.setSummaryText(((Style) this).mSummaryText);
                }
            }
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            if (!z || (arrayList = ((Style) this).mBuilder.mActions) == null || (min = Math.min(arrayList.size(), 3)) <= 0) {
                z2 = false;
            } else {
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(R.id.actions, generateActionButton(((Style) this).mBuilder.mActions.get(i2)));
                }
            }
            if (!z2) {
                i = 8;
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(((Style) this).mBuilder.mContext.getPackageName(), z ? R.layout.notification_action_tombstone : R.layout.notification_action);
            remoteViews.setImageViewBitmap(R.id.action_image, createColoredBitmap(action.getIcon(), ((Style) this).mBuilder.mContext.getResources().getColor(R.color.notification_action_color_filter)));
        ...
        public RemoteViews makeBigContentView(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            RemoteViews bigContentView = ((Style) this).mBuilder.getBigContentView();
            if (bigContentView == null) {
                bigContentView = ((Style) this).mBuilder.getContentView();
            }
            if (bigContentView == null) {
                return null;
            }
        ...
        public RemoteViews makeContentView(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (Build.VERSION.SDK_INT < 24 && ((Style) this).mBuilder.getContentView() != null) {
                return createRemoteViews(((Style) this).mBuilder.getContentView(), false);
            }
            return null;
        }
        ...
        public RemoteViews makeHeadsUpContentView(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            RemoteViews headsUpContentView = ((Style) this).mBuilder.getHeadsUpContentView();
            RemoteViews contentView = headsUpContentView != null ? headsUpContentView : ((Style) this).mBuilder.getContentView();
    ...
    public static class InboxStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (Build.VERSION.SDK_INT >= 16) {
                Notification.InboxStyle bigContentTitle = new Notification.InboxStyle(notificationBuilderWithBuilderAccessor.getBuilder()).setBigContentTitle(((Style) this).mBigContentTitle);
                if (((Style) this).mSummaryTextSet) {
                    bigContentTitle.setSummaryText(((Style) this).mSummaryText);
                }
    ...
    public static class MessagingStyle extends Style {
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            if (TextUtils.isEmpty(name)) {
                ...
                if (z && ((Style) this).mBuilder.getColor() != 0) {
                    i = ((Style) this).mBuilder.getColor();
                }
            }
        ...
        public boolean isGroupConversation() {
            Builder builder = ((Style) this).mBuilder;
