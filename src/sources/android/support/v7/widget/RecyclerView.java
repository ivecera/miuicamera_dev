...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(@NonNull VH vh, int i) {
            ((ViewHolder) vh).mPosition = i;
            if (hasStableIds()) {
                ((ViewHolder) vh).mItemId = getItemId(i);
            }
            vh.setFlags(1, 519);
            TraceCompat.beginSection(RecyclerView.TRACE_BIND_VIEW_TAG);
            onBindViewHolder(vh, i, vh.getUnmodifiedPayloads());
            vh.clearPayload();
            ViewGroup.LayoutParams layoutParams = ((ViewHolder) vh).itemView.getLayoutParams();
        ...
        public final VH createViewHolder(@NonNull ViewGroup viewGroup, int i) {
            try {
                ...
                if (((ViewHolder) onCreateViewHolder).itemView.getParent() == null) {
                    ((ViewHolder) onCreateViewHolder).mItemViewType = i;
