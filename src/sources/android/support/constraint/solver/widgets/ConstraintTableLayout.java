...
public class ConstraintTableLayout extends ConstraintWidgetContainer {
    ...
    private void setChildrenConnections() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ConstraintWidget constraintWidget = ((WidgetContainer) this).mChildren.get(i2);
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (size != 0) {
            setTableDimensions();
            if (linearSystem == ((ConstraintWidgetContainer) this).mSystem) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ((WidgetContainer) this).mChildren.get(i3).addToSolver(linearSystem);
                }
            }
        }
    }
    ...
    public String getColumnAlignmentRepresentation(int i) {
        ...
        return i2 == 1 ? "L" : i2 == 0 ? b.gy : i2 == 3 ? b.ky : i2 == 2 ? "R" : "!";
    }
    ...
    public void setTableDimensions() {
        ...
        int i = 0;
        for (int i2 = 0; i2 < size; i2++) {
            i += ((WidgetContainer) this).mChildren.get(i2).getContainerItemSkip();
        }
        int i3 = size + i;
