...
public class ErrorConstants {
    ...
    public static String APIErrorHandle(int i) {
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    case b.m /*{ENCODED_INT: 2001}*/:
                        return "内容没有发生变化";
                    case 2002:
                        return "Effect已下线";
                    case EFFECT_NOT_SUPPORT /*{ENCODED_INT: 2003}*/:
                        return "不支持当前设备";
                    case EFFECT_NOT_FOUND /*{ENCODED_INT: 2004}*/:
                        return "当前特效id不存在";
                    case EFFECT_NOT_IN_WHITE_LIST /*{ENCODED_INT: 2005}*/:
                        return "不在白名单";
                    case APP_NEED_UPGRADE /*{ENCODED_INT: 2006}*/:
                        return "需要更新app";
                    default:
                        switch (i) {
                            case CODE_CANCEL_DOWNLOAD /*{ENCODED_INT: 10001}*/:
                                return EXCEPTION_CANCEL_DOWNLOAD;
                            case CODE_DOWNLOAD_ERROR /*{ENCODED_INT: 10002}*/:
                                return EXCEPTION_DOWNLOAD_ERROR;
                            case CODE_EFFECT_NULL /*{ENCODED_INT: 10003}*/:
                                return EXCEPTION_EFFECT_NULL;
                            case CODE_INVALID_EFFECT_CACHE /*{ENCODED_INT: 10004}*/:
                                return EXCEPTION_INVALID_EFFECT_CACHE;
                            case CODE_SDK_ERROR /*{ENCODED_INT: 10005}*/:
                                return EXCEPTION_SDK_ERROR;
                            case CODE_NO_DOWNLOADED_EFFECTS /*{ENCODED_INT: 10006}*/:
                                return EXCEPTION_NO_DOWNLOADED_EFFECTS;
                            case CODE_PANEL_NULL /*{ENCODED_INT: 10007}*/:
                                return EXCEPTION_PANEL_NULL;
                            default:
                                switch (i) {
                                    case CODE_NO_LOCAL_TAG /*{ENCODED_INT: 10009}*/:
                                        return "没有本地 TAG 缓存";
                                    case CODE_MD5_ERROR /*{ENCODED_INT: 10010}*/:
                                        return EXCEPTION_MD5_ERROR;
                                    case CODE_NO_NETWORK /*{ENCODED_INT: 10011}*/:
                                        return "无网络";
                                    case CODE_IO_FAIL /*{ENCODED_INT: 10012}*/:
                                        return "io 错误";
                                    default:
                                        return "未知错误";
                                }
