...
public final class Decoder {
    ...
    private static final String[] LOWER_TABLE = {"CTRL_PS", " ", SupportedConfigFactory.CLOSE_BY_HHT, SupportedConfigFactory.CLOSE_BY_GROUP, SupportedConfigFactory.CLOSE_BY_SUPER_RESOLUTION, SupportedConfigFactory.CLOSE_BY_BURST_SHOOT, "e", SupportedConfigFactory.CLOSE_BY_BOKEH, SupportedConfigFactory.CLOSE_BY_HDR, SupportedConfigFactory.CLOSE_BY_VIDEO, SupportedConfigFactory.CLOSE_BY_ULTRA_WIDE, SupportedConfigFactory.CLOSE_BY_ULTRA_PIXEL, SupportedConfigFactory.CLOSE_BY_FILTER, SupportedConfigFactory.CLOSE_BY_RATIO, "m", "n", SupportedConfigFactory.CLOSE_BY_ULTRA_PIXEL_PORTRAIT, "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] MIXED_TABLE = {"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", "\n", "\u000b", "\f", "\r", "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", "_", "`", "|", "~", "", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", "\r", "\r\n", ". ", ", ", ": ", "!", "\"", "#", "$", "%", "&", "'", "(", ")", "*", "+", ",", "-", ".", "/", ":", ";", "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
    private static final String[] UPPER_TABLE = {"CTRL_PS", " ", ExifInterface.GpsStatus.IN_PROGRESS, b.fy, b.gy, b.ly, ExifInterface.GpsLongitudeRef.EAST, b.ky, "G", "H", b.iy, b.jy, ExifInterface.GpsSpeedRef.KILOMETERS, "L", "M", "N", "O", "P", "Q", "R", "S", ExifInterface.GpsTrackRef.TRUE_DIRECTION, "U", "V", ExifInterface.GpsLongitudeRef.WEST, "X", "Y", b.ey, "CTRL_LL", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
