...
public final class Encoder {
    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (i2 != 0) {
            ...
            int i14 = 0;
            while (i14 <= 32) {
                boolean z2 = i14 <= 3 ? i11 : i10;
                int i15 = z2 ? i14 + 1 : i14;
                int i16 = totalBitsInLayer(i15, z2);
                if (size2 <= i16) {
                    if (bitArray3 == null || i13 != WORD_SIZE[i15]) {
                        i3 = WORD_SIZE[i15];
        ...
        int i19 = 2;
        if (z) {
            for (int i20 = i10; i20 < iArr.length; i20++) {
                iArr[i20] = i20;
            }
            i6 = i18;
        } else {
            ...
            i6 = i18 + 1 + (((i21 - 1) / 15) * 2);
            int i22 = i6 / 2;
            for (int i23 = i10; i23 < i21; i23++) {
                int i24 = (i23 / 15) + i23;
                iArr[(i21 - i23) - i11] = (i22 - i24) - 1;
            ...
            while (i28 < i27) {
                ...
                while (i10 < i19) {
                    ...
                    if (generateCheckWords.get((i27 << 1) + i26 + i29 + i10)) {
                        int i31 = i25 << 1;
                        bitMatrix.set(iArr[i31 + i28], iArr[((i18 - 1) - i31) - i10]);
                    }
                    ...
                    if (generateCheckWords.get((i27 * 6) + i26 + i29 + i10)) {
                        int i33 = i25 << 1;
                        bitMatrix.set(iArr[((i18 - 1) - i33) - i28], iArr[i33 + i10]);
                    }
                    i10++;
                    i19 = 2;
                }
