...
public final class VEventResultParser extends ResultParser {
    ...
    public CalendarParsedResult parse(Result result) {
        ...
        if (matchSingleVCardPrefixedField7 == null) {
            ...
            try {
                d3 = Double.parseDouble(matchSingleVCardPrefixedField7.substring(0, indexOf));
                d2 = Double.parseDouble(matchSingleVCardPrefixedField7.substring(indexOf + 1));
            } catch (NumberFormatException unused) {
                return null;
            }
        }
        return new CalendarParsedResult(matchSingleVCardPrefixedField, matchSingleVCardPrefixedField2, matchSingleVCardPrefixedField3, matchSingleVCardPrefixedField4, matchSingleVCardPrefixedField5, stripMailto, matchVCardPrefixedField, matchSingleVCardPrefixedField6, d3, d2);
    }
}
