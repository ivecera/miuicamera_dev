    ...
    private void validatePattern(int i) throws NotFoundException {
        ...
        while (true) {
            ...
            while (i11 >= 0) {
                ...
                float f2 = (float) this.counters[i + i11];
        ...
        if (i2 >= this.counterLength || i4 >= i5 / 2) {
            ...
            if (arrayContains(STARTEND_ENCODING, this.decodeRowResult.charAt(0))) {
                ...
                if (!arrayContains(STARTEND_ENCODING, sb2.charAt(sb2.length() - 1))) {
                    ...
                    float f3 = (float) i;
                    return new Result(this.decodeRowResult.toString(), null, new ResultPoint[]{new ResultPoint(f2, f3), new ResultPoint((float) i8, f3)}, BarcodeFormat.CODABAR);
                } else {
                    throw NotFoundException.getNotFoundInstance();
                }
            } else {
