    ...
    private static String getMessage(byte[] bArr, int i, int i2) {
        ...
        while (i4 < i + i2) {
            ...
            switch (charAt) {
                ...
                case 65521:
                case 65522:
                case BaseFragmentDelegate.FRAGMENT_VV:
                case BaseFragmentDelegate.FRAGMENT_VV_GALLERY:
                    i6 = i5;
                    i5 = charAt - SHIFTA;
                    i3 = 1;
                    break;
                case BaseFragmentDelegate.FRAGMENT_VV_PREVIEW:
                    i3 = 2;
                    i6 = i5;
                    i5 = 0;
                    break;
                case BaseFragmentDelegate.FRAGMENT_VV_PROCESS:
                    i3 = 3;
                    i6 = i5;
                    i5 = 0;
                    break;
                case BaseFragmentDelegate.FRAGMENT_SUBTITLE:
                    i5 = 0;
                    i3 = -1;
                    break;
                case BaseFragmentDelegate.FRAGMENT_ID_CARD:
                    i3 = -1;
                    i5 = 1;
                    break;
                case 65529:
                    i3 = -1;
                    break;
                case BaseFragmentDelegate.FRAGMENT_KALEIDOSCOPE:
                default:
                    sb.append(charAt);
                    break;
                case 65531:
