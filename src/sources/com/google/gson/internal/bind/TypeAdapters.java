...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<BitSet> BIT_SET = new TypeAdapter<BitSet>() {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:16:0x0038, code lost:
            if (java.lang.Integer.parseInt(r0) != 0) goto L_0x0076;
         */
    ...
    public static final TypeAdapterFactory TIMESTAMP_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
            ...
            return new TypeAdapter<Timestamp>() {
                /* class com.google.gson.internal.bind.TypeAdapters.AnonymousClass22.AnonymousClass1 */
    ...
    private static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public EnumTypeAdapter(Class<T> cls) {
            try {
                ...
                for (T t : enumConstants) {
                    String name = t.name();
                    T annotation = cls.getField(name).getAnnotation(SerializedName.class);
        ...
        public /* bridge */ /* synthetic */ void write(JsonWriter jsonWriter, Object obj) throws IOException {
            write(jsonWriter, (Enum) ((Enum) obj));
        }
    }
