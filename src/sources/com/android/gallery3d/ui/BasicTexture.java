...
public abstract class BasicTexture implements Texture {
    ...
    public void setSize(int i, int i2) {
        ...
        if (this.mTextureWidth > MAX_TEXTURE_SIZE || this.mTextureHeight > MAX_TEXTURE_SIZE) {
            Log.w(TAG, String.format(Locale.ENGLISH, "texture is too large: %d x %d", Integer.valueOf(this.mTextureWidth), Integer.valueOf(this.mTextureHeight)), new Exception());
        }
    }
