...
public class FunctionDataSetup extends Func1Base<BaseModule, BaseModule> {
    ...
    public NullHolder<BaseModule> apply(@NonNull NullHolder<BaseModule> nullHolder) throws Exception {
        ...
        dataItemConfig.reInitComponent(((Func1Base) this).mTargetMode, baseModule.getBogusCameraId(), baseModule.getCameraCapabilities());
        dataItemRunning.reInitComponent(((Func1Base) this).mTargetMode, baseModule.getBogusCameraId(), baseModule.getCameraCapabilities());
