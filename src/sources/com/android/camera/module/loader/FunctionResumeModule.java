...
public class FunctionResumeModule extends Func1Base<BaseModule, BaseModule> {
    ...
    public NullHolder<BaseModule> apply(@NonNull NullHolder<BaseModule> nullHolder) throws Exception {
        ...
        DataRepository.getInstance().backUp().revertRunning(DataRepository.dataItemRunning(), dataItemGlobal.getDataBackUpKey(((Func1Base) this).mTargetMode), dataItemGlobal.getCurrentCameraId());
