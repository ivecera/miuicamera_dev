...
public class ComponentManuallyISO extends ComponentData {
    ...
    private ComponentDataItem[] getFullItems() {
        ...
        if (DataRepository.dataItemFeature().bf() || DataRepository.dataItemFeature().Ue()) {
    ...
    public boolean checkValueValid(int i, String str) {
        return Util.isStringValueContained(str, (DataRepository.dataItemFeature().bf() || DataRepository.dataItemFeature().Ue()) ? R.array.pref_camera_iso_entryvalues_new : R.array.pref_camera_iso_entryvalues);
    }
