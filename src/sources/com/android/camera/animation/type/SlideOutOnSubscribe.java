...
public class SlideOutOnSubscribe extends BaseOnSubScribe {
    ...
    public ViewPropertyAnimatorCompat getAnimation() {
        ...
        if (i3 == 3) {
            ...
            ViewCompat.setTranslationX(((BaseOnSubScribe) this).mAniView, 0.0f);
            ViewCompat.setTranslationY(((BaseOnSubScribe) this).mAniView, 0.0f);
            ViewCompat.setAlpha(((BaseOnSubScribe) this).mAniView, 1.0f);
            return ViewCompat.animate(((BaseOnSubScribe) this).mAniView).translationX((float) i2).translationY((float) i);
        }
        i2 = max;
        i = 0;
        ViewCompat.setTranslationX(((BaseOnSubScribe) this).mAniView, 0.0f);
