...
public class CameraPreferenceActivity extends BasePreferenceActivity {
    ...
    private boolean isHeicImageFormatSelectable() {
        if (!DataRepository.dataItemFeature().c_28041_0x0005() || !CameraSettings.isCameraParallelProcessEnable() || !DataRepository.dataItemGlobal().isNormalIntent() || CameraSettings.isLiveShotOn() || CameraSettings.isDocumentModeOn(this.mFromWhere)) {
            return false;
        }
        int i = this.mFromWhere;
