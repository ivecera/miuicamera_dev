...
public class HorizontalSlideView extends BaseHorizontalZoomView {
    ...
    private GestureDetector.OnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        /* class com.android.camera.ui.HorizontalSlideView.AnonymousClass1 */
        ...
        public boolean onSingleTapUp(MotionEvent motionEvent) {
            if (!HorizontalSlideView.this.mTouchDown) {
                Log.d(HorizontalSlideView.TAG, "onSingleTapUp: trigger the wrong MotionEvent and ignore it .  e.getX " + motionEvent.getX() + " | action is " + motionEvent.getAction());
                return false;
            }
    ...
    private float calculateLength(int i, int i2) {
        ...
        if (this.mDrawAdapter != null) {
            ...
            for (int i4 = 0; i4 < this.mDrawAdapter.getCount(); i4++) {
                ...
                float f8 = z ? f3 : f6 + f7;
                f6 += z2 ? 0.0f : itemWidth + getItemGap(i4);
                if (i5 == i) {
                    f2 = f8;
                } else if (i5 == i2) {
                    f5 = f8;
