...
public class StickerInfo extends Resource {
    ...
    public int getFilterId() {
        if (!TextUtils.isEmpty(((Resource) this).extra)) {
            try {
                return new JSONObject(((Resource) this).extra).getInt(EXTRA_FILTER_ID);
    ...
    public String getSrcPath() {
        return this.isLocal ? this.srcPath : StickerHelper.getInstance().getStickerPath(((Resource) this).id);
    }
    ...
    public boolean isDownloaded() {
        ...
        return new File(StickerHelper.getInstance().getStickerPath(((Resource) this).id)).exists();
    }
}
