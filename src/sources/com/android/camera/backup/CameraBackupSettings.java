...
public class CameraBackupSettings {
    ...
    static final e.a[] PREF_ENTRIES = {e.a.q("version", CameraSettings.KEY_VERSION), e.a.p(KEY_RECORD_LOCATION, "pref_camera_recordlocation_key"), e.a.p(KEY_CAMERA_SOUND, "pref_camerasound_key"), e.a.p(KEY_CAMERA_PROXIMITY_LOCK, "pref_camera_proximity_lock_key"), e.a.p(KEY_PRIORITY_STORAGE, "pref_priority_storage"), e.a.p(KEY_RETAIN_CAMERA_MODE, "pref_retain_camera_mode_key"), e.a.s(KEY_CAMERA_SNAP, "pref_camera_snap_key"), e.a.p(KEY_CAPTURE_WHEN_STABLE, "pref_capture_when_stable_key"), e.a.p("watermark", "pref_time_watermark_key"), e.a.p(KEY_DUALCAMERA_WATERMARK, "pref_dualcamera_watermark_key"), e.a.p(KEY_CAMERA_USER_WATERMARK, "user_define_watermark_key"), e.a.p(KEY_AUTO_CHROMA_FLASH, "pref_auto_chroma_flash_key"), e.a.p(KEY_REFERENCE_LINE, "pref_camera_referenceline_key"), e.a.p(KEY_FOCUS_SHOOT, "pref_camera_focus_shoot_key"), e.a.p(KEY_SCAN_QRCODE, "pref_scan_qrcode_key"), e.a.p(KEY_CAMERA_ASD_NIGHT, "pref_camera_asd_night_key"), e.a.p(KEY_CAMERA_GROUPSHOT_PRIMITIVE, CameraSettings.KEY_CAMERA_GROUPSHOT_PRIMITIVE), e.a.s(KEY_LONG_PRESS_SHUTTER, "pref_camera_long_press_shutter_key"), e.a.s(KEY_LONG_PRESS_SHUTTER_FEATURE, "pref_camera_long_press_shutter_feature_key"), e.a.s(KEY_FRONT_MIRROR, "pref_front_mirror_key"), e.a.s(KEY_JPEG_QUALITY, "pref_camera_jpegquality_key"), e.a.p(KEY_HEIC_FORMAT, CameraSettings.KEY_HEIC_FORMAT), e.a.p(KEY_CAMERA_LYING_TIP_SWITCH, "pref_camera_lying_tip_switch_key"), e.a.p(KEY_MOVIE_SOLID, "pref_camera_movie_solid_key"), e.a.s(KEY_VIDEO_ENCODER, "pref_video_encoder_key"), e.a.s(KEY_VIDEO_TIME_LAPSE_FRAME_INTERVAL, "pref_video_time_lapse_frame_interval_key"), e.a.p(KEY_FACE_DETECTION, "pref_camera_facedetection_key"), e.a.p(KEY_FINGERPRINT_CAPTURE, "pref_fingerprint_capture_key"), e.a.s(KEY_VOLUME_CAMERA_FUNCTION, "pref_camera_volumekey_function_key"), e.a.s(KEY_VOLUME_VIDEO_FUNCTION, "pref_video_volumekey_function_key"), e.a.s(KEY_VOLUME_PRO_VIDEO_FUNCTION, CameraSettings.KEY_VOLUME_PRO_VIDEO_FUNCTION), e.a.s(KEY_VOLUME_LIVE_FUNCTION, "pref_live_volumekey_function_key"), e.a.s(KEY_ANTIBANDING, "pref_camera_antibanding_key"), e.a.s(KEY_QC_CONTRAST, "pref_qc_camera_contrast_key"), e.a.s(KEY_QC_SATURATION, "pref_qc_camera_saturation_key"), e.a.s(KEY_QC_SHARPNESS, "pref_qc_camera_sharpness_key"), e.a.s(KEY_WHITE_BALANCE, CameraSettings.KEY_WHITE_BALANCE), e.a.s("focus_position", CameraSettings.KEY_QC_FOCUS_POSITION), e.a.s(KEY_QC_EXPOSURETIME, CameraSettings.KEY_QC_EXPOSURETIME), e.a.s(KEY_QC_ISO, CameraSettings.KEY_QC_ISO), e.a.q(KEY_QC_MANUAL_WHITEBALANCE_VALUE, "pref_qc_manual_whitebalance_k_value_key"), e.a.s(KEY_FACE_BEAUTY, "pref_beautify_level_key_capture"), e.a.s(KEY_FACE_BEAUTY_SWITCH, CameraSettings.KEY_FACE_BEAUTY_SWITCH), e.a.q(KEY_BEAUTIFY_SLIM_FACE_RATIO, "pref_beautify_slim_face_ratio_key"), e.a.q(KEY_BEAUTIFY_SKIN_SMOOTH_RATIO, "pref_beautify_skin_smooth_ratio_key"), e.a.q(KEY_BEAUTIFY_SKIN_COLOR_RATIO, "pref_beautify_skin_color_ratio_key"), e.a.q(KEY_BEAUTIFY_ENLARGE_EYE_RATIO, "pref_beautify_enlarge_eye_ratio_key")};
}
