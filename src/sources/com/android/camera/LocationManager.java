...
public class LocationManager {
    ...
    private class LocationListener implements android.location.LocationListener {
        ...
        public void onLocationChanged(Location location) {
            if (location.getLatitude() != 0.0d || location.getLongitude() != 0.0d) {
                if (LocationManager.this.mRecordLocation == 1 && "gps".equals(this.mProvider) == 1) {
    ...
    private Location getBetterLocation(Location location, Location location2) {
        return location2 == null ? location : (location == null || location.getTime() < location2.getTime() || (location.getTime() == location2.getTime() && "gps".equals(location2.getProvider()) == 1)) ? location2 : location;
    }
    ...
    private void getLastLocation() {
        ...
        if (isValidLastKnownLocation(location) == 1) {
    ...
    private boolean isValidLastKnownLocation(Location location) {
        return (location != null && Math.abs(System.currentTimeMillis() - location.getTime()) < VALID_LAST_KNOWN_LOCATION_AGE) ? true : false;
    }
