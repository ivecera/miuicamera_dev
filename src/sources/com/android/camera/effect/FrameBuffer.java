...
public class FrameBuffer {
    ...
    public FrameBuffer(GLCanvas gLCanvas, int i, int i2, int i3) {
        ...
        Log.v(TAG, String.format(Locale.ENGLISH, "init@2: fbo=%d tex=%d %d*%d thread=%d", Integer.valueOf(getId()), Integer.valueOf(this.mTexture.getId()), Integer.valueOf(i), Integer.valueOf(i2), Long.valueOf(Thread.currentThread().getId())));
    }
    ...
    public FrameBuffer(GLCanvas gLCanvas, RGBTexture rGBTexture, int i) {
        ...
        this.mGLCanvas = gLCanvas;
        Log.v(TAG, String.format(Locale.ENGLISH, "init@1: fbo=%d tex=%d", Integer.valueOf(getId()), Integer.valueOf(this.mTexture.getId())));
    }
    ...
    public FrameBuffer(GLCanvas gLCanvas, RawTexture rawTexture, int i) {
        ...
        this.mGLCanvas = gLCanvas;
        Log.v(TAG, String.format(Locale.ENGLISH, "init@1: fbo=%d tex=%d %d*%d thread=%d", Integer.valueOf(getId()), Integer.valueOf(this.mTexture.getId()), Integer.valueOf(rawTexture.getWidth()), Integer.valueOf(rawTexture.getHeight()), Long.valueOf(Thread.currentThread().getId())));
    }
    ...
    public void finalize() {
        if (this.mGLCanvas != null) {
            Log.d(TAG, String.format(Locale.ENGLISH, "delete fbo thread=%d id=%d", Long.valueOf(Thread.currentThread().getId()), Integer.valueOf(getId())));
    ...
    public void release() {
        if (this.mGLCanvas != null) {
            Log.d(TAG, String.format(Locale.ENGLISH, "delete framebuffer thread=%d id=%d", Long.valueOf(Thread.currentThread().getId()), Integer.valueOf(getId())));
            this.mGLCanvas.deleteFrameBuffer(getId());
            this.mGLCanvas = null;
        }
