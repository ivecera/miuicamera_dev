...
class FocusPeakingFirstPassRender extends ConvolutionEffectRender {
    ...
    public void initShader() {
        super.initShader();
        this.mUniformThresholdH = GLES20.glGetUniformLocation(((ShaderRender) this).mProgram, "uThreshold");
        this.mUniformPeakColorH = GLES20.glGetUniformLocation(((ShaderRender) this).mProgram, "uPeakColor");
    }
