...
public class EffectRenderGroup extends RenderGroup implements EffectController.EffectChangedListener {
    ...
    private void drawAnimationMask(DrawAttribute drawAttribute) {
        ...
        if (blurAnimationValue > 0) {
            ...
            ((Render) this).mGLCanvas.draw(new FillRectAttribute(0.0f, 0.0f, (float) drawExtTexAttribute.mWidth, (float) drawExtTexAttribute.mHeight, Color.argb(blurAnimationValue, 0, 0, 0)));
        }
    }
    ...
    private boolean updatePreviewSecondRender() {
        ...
        synchronized (this.mRenderChangedLock) {
            ...
            this.mPreviewSecondRender.setFrameBufferSize(((Render) this).mPreviewWidth, ((Render) this).mPreviewHeight);
