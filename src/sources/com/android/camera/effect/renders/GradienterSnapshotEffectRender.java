...
public class GradienterSnapshotEffectRender extends PixelEffectRender {
    ...
    private float getRotation() {
        float f2 = ((Render) this).mShootRotation - ((float) ((Render) this).mOrientation);
    ...
    public void initShader() {
        super.initShader();
        this.mUniformAngle = GLES20.glGetUniformLocation(((ShaderRender) this).mProgram, "sAngle");
        this.mUniformTexSize = GLES20.glGetUniformLocation(((ShaderRender) this).mProgram, "vTexSize");
        this.mUniformTargetSize = GLES20.glGetUniformLocation(((ShaderRender) this).mProgram, "vTargetSize");
        this.mUniformTargetCenter = GLES20.glGetUniformLocation(((ShaderRender) this).mProgram, "vTargetCenter");
    ...
    public void initShaderValue(boolean z) {
        ...
        int i2 = ((Render) this).mSnapshotOriginWidth;
        if (i2 != 0 && (i = ((Render) this).mSnapshotOriginHeight) != 0) {
            GLES20.glUniform2f(this.mUniformTexSize, (float) i2, (float) i);
            float f2 = ((float) ((Render) this).mSnapshotOriginWidth) * 0.5f;
            float f3 = ((float) ((Render) this).mSnapshotOriginHeight) * 0.5f;
            if (ModuleManager.isSquareModule()) {
                float min = (float) Math.min(((Render) this).mSnapshotOriginWidth, ((Render) this).mSnapshotOriginHeight);
                GLES20.glUniform2f(this.mUniformTargetSize, min, min);
                int i3 = ((Render) this).mSnapshotOriginWidth;
                int i4 = ((Render) this).mSnapshotOriginHeight;
                if (i3 > i4) {
                ...
                GLES20.glUniform2f(this.mUniformTargetSize, (float) ((Render) this).mSnapshotOriginWidth, (float) ((Render) this).mSnapshotOriginHeight);
            }
