...
public class YGaussianEffectRender extends RegionEffectRender {
    ...
    public YGaussianEffectRender(GLCanvas gLCanvas) {
        super(gLCanvas);
    }

    public YGaussianEffectRender(GLCanvas gLCanvas, int i) {
        super(gLCanvas, i);
    }
