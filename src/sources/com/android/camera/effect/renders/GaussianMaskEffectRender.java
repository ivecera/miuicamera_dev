...
public class GaussianMaskEffectRender extends RegionEffectRender {
    ...
    @Override // com.android.camera.effect.renders.RegionEffectRender, com.android.camera.effect.renders.PixelEffectRender, com.android.camera.effect.renders.ConvolutionEffectRender, com.android.camera.effect.renders.ShaderRender
    public void initShader() {
        super.initShader();
        this.mUniformMaskAlphaH = GLES20.glGetUniformLocation(((ShaderRender) this).mProgram, "uMaskAlpha");
    }

    /* access modifiers changed from: protected */
    @Override // com.android.camera.effect.renders.RegionEffectRender, com.android.camera.effect.renders.PixelEffectRender, com.android.camera.effect.renders.ConvolutionEffectRender
