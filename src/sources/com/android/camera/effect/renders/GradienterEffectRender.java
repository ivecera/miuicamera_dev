...
public class GradienterEffectRender extends PixelEffectRender {
    ...
    public void initShaderValue(boolean z) {
        ...
        GLES20.glUniform2f(this.mUniformTexSize, (float) ((Render) this).mPreviewWidth, (float) ((Render) this).mPreviewHeight);
        float f2 = ((float) ((Render) this).mPreviewWidth) * 0.5f;
        float f3 = ((float) ((Render) this).mPreviewHeight) * 0.5f;
        if (ModuleManager.isSquareModule()) {
            float min = (float) Math.min(((Render) this).mPreviewWidth, ((Render) this).mPreviewHeight);
            GLES20.glUniform2f(this.mUniformTargetSize, min, min);
            f3 -= (float) ((this.mSquareModeExtraMargin * ((Render) this).mPreviewWidth) / Util.sWindowWidth);
        } else {
            GLES20.glUniform2f(this.mUniformTargetSize, (float) ((Render) this).mPreviewWidth, (float) ((Render) this).mPreviewHeight);
        }
