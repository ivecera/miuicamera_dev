...
public class MimojiEditGLSurfaceView2 extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    private class MyEGLConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        private MyEGLConfigChooser() {
            ...
            this.ATTR_NAME = new String[]{"R", "G", miui.reflect.b.fy, ExifInterface.GpsStatus.IN_PROGRESS, miui.reflect.b.ly, "S", "ID", "CAVEAT"};
        }
        ...
        private void logConfig(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
            ...
            while (true) {
                ...
                if (i < iArr2.length) {
                    ...
                    Log.i(MimojiEditGLSurfaceView2.TAG, "Config chosen: " + sb.toString());
                    return;
                }
            }
        }
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        if (!this.mIsStopRender) {
            ...
            if (this.mSaveConfigThum) {
                ...
                AvatarEngineManager2.getInstance().queryAvatar().renderThumb(244, 292, 21, 20, bArr, 200, 200, MediaPlayer2.MEDIA_INFO_BAD_INTERLEAVING, BACKGROUND_COLOR, 1.0f);
