...
public class BeautyValues implements Parcelable {
    public static final Parcelable.Creator<BeautyValues> CREATOR = new Parcelable.Creator<BeautyValues>() {
        /* class com.android.camera.fragment.beauty.BeautyValues.AnonymousClass1 */
    ...
    public boolean isBeautyModelOn() {
        ...
        int i2;
        int i3;
        return this.mBeautySlimFace > 0 || this.mBeautyEnlargeEye > 0 || this.mBeautyNose > 0 || this.mBeautyRisorius > 0 || !((i = this.mBeautyLips) == 0 || i == 0) || (!((i2 = this.mBeautyChin) == 0 || i2 == 0) || this.mBeautyNeck > 0 || this.mBeautySmile > 0 || this.mBeautySlimNose > 0 || !((i3 = this.mBeautyHairLine) == 0 || i3 == 0));
    }
