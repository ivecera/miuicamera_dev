...
public class FragmentParameterDescription extends BaseDialogFragment {
    ...
    private List<ComponentDataItem> getParameterData() {
        ...
        if (DataRepository.dataItemFeature().m1if() && DataRepository.dataItemFeature().jf()) {
