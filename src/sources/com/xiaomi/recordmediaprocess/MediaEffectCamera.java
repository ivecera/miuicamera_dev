...
public class MediaEffectCamera {
    ...
    public void StartRecording(String str, String str2, String str3, long j, float f2, long j2) {
        String str4 = TAG;
        Log.d(str4, "Start MediaFilterCamera: " + this.mMediaFilterCamera + " filePath: " + str + "record_video_max_duration:" + j2);
        StartRecordingJni(this.mMediaFilterCamera, 0, str, "", str2, str3, j, f2, j2);
    }
