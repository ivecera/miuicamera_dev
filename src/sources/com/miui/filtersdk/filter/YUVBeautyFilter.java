...
public class YUVBeautyFilter extends BaseBeautyFilter {
    ...
    public void genYUVTextures(byte[] bArr, final int i, final int i2) {
        ((BaseBeautyFilter) this).mBeautyProcessor.beautify(bArr, 0, i, i2, null, 0);
        int i3 = i * i2;
        ...
        runOnDraw(new Runnable() {
            /* class com.miui.filtersdk.filter.YUVBeautyFilter.AnonymousClass1 */
    ...
    public void onInit() {
        ...
        this.mGLUniformYTexture = GLES20.glGetUniformLocation(((GPUImageFilter) this).mGLProgId, "y_texture");
        this.mGLUniformUVTexture = GLES20.glGetUniformLocation(((GPUImageFilter) this).mGLProgId, "uv_texture");
