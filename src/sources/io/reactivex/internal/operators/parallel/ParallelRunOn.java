...
public final class ParallelRunOn<T> extends ParallelFlowable<T> {
    ...
    static final class RunOnConditionalSubscriber<T> extends BaseRunOnSubscriber<T> {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(((BaseRunOnSubscriber) this).s, subscription)) {
                ((BaseRunOnSubscriber) this).s = subscription;
                this.actual.onSubscribe(this);
                subscription.request((long) ((BaseRunOnSubscriber) this).prefetch);
            }
        }
        ...
        public void run() {
            int i;
            Throwable th;
            int i2 = ((BaseRunOnSubscriber) this).consumed;
            SpscArrayQueue<T> spscArrayQueue = ((BaseRunOnSubscriber) this).queue;
            ConditionalSubscriber<? super T> conditionalSubscriber = this.actual;
            int i3 = ((BaseRunOnSubscriber) this).limit;
            int i4 = 1;
            while (true) {
                long j = ((BaseRunOnSubscriber) this).requested.get();
                long j2 = 0;
                while (true) {
                    i = (j2 > j ? 1 : (j2 == j ? 0 : -1));
                    if (i == 0) {
                        break;
                    } else if (((BaseRunOnSubscriber) this).cancelled) {
                        spscArrayQueue.clear();
                        return;
                    } else {
                        boolean z = ((BaseRunOnSubscriber) this).done;
                        if (!z || (th = ((BaseRunOnSubscriber) this).error) == null) {
                            T poll = spscArrayQueue.poll();
                            boolean z2 = poll == null;
                            if (z && z2) {
                                conditionalSubscriber.onComplete();
                                ((BaseRunOnSubscriber) this).worker.dispose();
                                return;
                            } else if (z2) {
                                break;
                            } else {
                                ...
                                i2++;
                                if (i2 == i3) {
                                    ((BaseRunOnSubscriber) this).s.request((long) i2);
                                    i2 = 0;
                                }
                            }
                        } else {
                ...
                if (i == 0) {
                    if (((BaseRunOnSubscriber) this).cancelled) {
                        spscArrayQueue.clear();
                        return;
                    } else if (((BaseRunOnSubscriber) this).done) {
                        Throwable th2 = ((BaseRunOnSubscriber) this).error;
                        if (th2 != null) {
                            spscArrayQueue.clear();
                ...
                if (!(j2 == 0 || j == Long.MAX_VALUE)) {
                    ((BaseRunOnSubscriber) this).requested.addAndGet(-j2);
                }
                int i5 = get();
                if (i5 == i4) {
                    ((BaseRunOnSubscriber) this).consumed = i2;
                    i4 = addAndGet(-i4);
                    if (i4 == 0) {
                        return;
                    }
