...
public final class FlowableTimeout<T, U, V> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class TimeoutConsumer extends AtomicReference<Subscription> implements FlowableSubscriber<Object>, Disposable {
        ...
        public void onComplete() {
            V v = get();
            V v2 = SubscriptionHelper.CANCELLED;
            if (v != v2) {
                lazySet(v2);
        ...
        public void onNext(Object obj) {
            V v = get();
            if (v != SubscriptionHelper.CANCELLED) {
                v.cancel();
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ...
        if (publisher == null) {
            ...
            ((AbstractFlowableWithUpstream) this).source.subscribe((FlowableSubscriber) timeoutSubscriber);
            return;
        }
        ...
        ((AbstractFlowableWithUpstream) this).source.subscribe((FlowableSubscriber) timeoutFallbackSubscriber);
    }
}
