...
public final class ObservableTimeoutTimed<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    public void subscribeActual(Observer<? super T> observer) {
        if (this.other == null) {
            ((AbstractObservableWithUpstream) this).source.subscribe(new TimeoutTimedObserver(new SerializedObserver(observer), this.timeout, this.unit, this.scheduler.createWorker()));
        } else {
            ((AbstractObservableWithUpstream) this).source.subscribe(new TimeoutTimedOtherObserver(observer, this.timeout, this.unit, this.scheduler.createWorker(), this.other));
        }
    }
}
