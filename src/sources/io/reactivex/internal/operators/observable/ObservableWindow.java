...
public final class ObservableWindow<T> extends AbstractObservableWithUpstream<T, Observable<T>> {
    ...
    public void subscribeActual(Observer<? super Observable<T>> observer) {
        ...
        long j2 = this.skip;
        if (j == j2) {
            ((AbstractObservableWithUpstream) this).source.subscribe(new WindowExactObserver(observer, j, this.capacityHint));
        } else {
            ((AbstractObservableWithUpstream) this).source.subscribe(new WindowSkipObserver(observer, j, j2, this.capacityHint));
        }
    }
}
