    ...
    public void subscribeActual(Observer<? super U> observer) {
        ...
        if (i == i2) {
            ...
            if (bufferExactObserver.createBuffer()) {
                ((AbstractObservableWithUpstream) this).source.subscribe(bufferExactObserver);
                return;
            }
            return;
        }
        ((AbstractObservableWithUpstream) this).source.subscribe(new BufferSkipObserver(observer, i2, i, this.bufferSupplier));
    }
}
