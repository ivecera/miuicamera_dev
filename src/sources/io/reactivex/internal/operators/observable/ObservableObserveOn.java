...
public final class ObservableObserveOn<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        if (scheduler2 instanceof TrampolineScheduler) {
            ((AbstractObservableWithUpstream) this).source.subscribe(observer);
            return;
        }
        ((AbstractObservableWithUpstream) this).source.subscribe(new ObserveOnObserver(observer, scheduler2.createWorker(), this.delayError, this.bufferSize));
    }
}
