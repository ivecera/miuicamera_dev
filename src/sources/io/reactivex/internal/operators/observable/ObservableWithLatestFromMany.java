...
public final class ObservableWithLatestFromMany<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class WithLatestFromObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        final AtomicReference<Disposable> f744d;
        ...
        WithLatestFromObserver(Observer<? super R> observer, Function<? super Object[], R> function, int i) {
            ...
            this.f744d = new AtomicReference<>();
        ...
        public void dispose() {
            DisposableHelper.dispose(this.f744d);
        ...
        public boolean isDisposed() {
            return DisposableHelper.isDisposed(this.f744d.get());
        }
        ...
        public void onSubscribe(Disposable disposable) {
            DisposableHelper.setOnce(this.f744d, disposable);
        }

        /* access modifiers changed from: package-private */
        public void subscribe(ObservableSource<?>[] observableSourceArr, int i) {
            WithLatestInnerObserver[] withLatestInnerObserverArr = this.observers;
            AtomicReference<Disposable> atomicReference = this.f744d;
    ...
    public void subscribeActual(Observer<? super R> observer) {
        ...
        if (i == 0) {
            new ObservableMap(((AbstractObservableWithUpstream) this).source, new SingletonArrayFunc()).subscribeActual(observer);
            return;
        }
        ...
        ((AbstractObservableWithUpstream) this).source.subscribe(withLatestFromObserver);
    }
}
