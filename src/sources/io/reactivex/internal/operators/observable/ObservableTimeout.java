...
public final class ObservableTimeout<T, U, V> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class TimeoutObserver<T, U, V> extends AtomicReference<Disposable> implements Observer<T>, Disposable, OnTimeout {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                V timeoutInnerObserver = new TimeoutInnerObserver(this, j);
                if (compareAndSet(v, timeoutInnerObserver)) {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.s, disposable)) {
                ...
                if (observableSource != null) {
                    V timeoutInnerObserver = new TimeoutInnerObserver(this, 0);
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        if (observableSource == null) {
            ((AbstractObservableWithUpstream) this).source.subscribe(new TimeoutObserver(new SerializedObserver(observer), this.firstTimeoutIndicator, this.itemTimeoutIndicator));
        } else {
            ((AbstractObservableWithUpstream) this).source.subscribe(new TimeoutOtherObserver(observer, this.firstTimeoutIndicator, this.itemTimeoutIndicator, observableSource));
        }
    }
}
