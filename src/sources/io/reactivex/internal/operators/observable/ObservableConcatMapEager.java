...
public final class ObservableConcatMapEager<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    public void subscribeActual(Observer<? super R> observer) {
        ((AbstractObservableWithUpstream) this).source.subscribe(new ConcatMapEagerMainObserver(observer, this.mapper, this.maxConcurrency, this.prefetch, this.errorMode));
    }
}
