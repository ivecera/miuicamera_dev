...
public final class MaybeDelayOtherPublisher<T, U> extends AbstractMaybeWithUpstream<T, T> {
    ...
    static final class DelayMaybeObserver<T, U> implements MaybeObserver<T>, Disposable {
        ...
        public void dispose() {
            this.f697d.dispose();
            this.f697d = DisposableHelper.DISPOSED;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f697d, disposable)) {
                this.f697d = disposable;
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        ((AbstractMaybeWithUpstream) this).source.subscribe(new DelayMaybeObserver(maybeObserver, this.other));
    }
}
