...
public abstract class QueueDrainSubscriber<T, U, V> extends QueueDrainSubscriberPad4 implements FlowableSubscriber<T>, QueueDrain<U, V> {
    ...
    public final void fastPathEmitMax(U u, boolean z, Disposable disposable) {
        ...
        if (((QueueDrainSubscriberWip) this).wip.get() != 0 || !((QueueDrainSubscriberWip) this).wip.compareAndSet(0, 1)) {
            ...
            long j = ((QueueDrainSubscriberPad3) this).requested.get();
            if (j != 0) {
    ...
    public final long produced(long j) {
        return ((QueueDrainSubscriberPad3) this).requested.addAndGet(-j);
    }

    @Override // io.reactivex.internal.util.QueueDrain
    public final long requested() {
        return ((QueueDrainSubscriberPad3) this).requested.get();
    }

    public final void requested(long j) {
        if (SubscriptionHelper.validate(j)) {
            BackpressureHelper.add(((QueueDrainSubscriberPad3) this).requested, j);
        }
    }
}
