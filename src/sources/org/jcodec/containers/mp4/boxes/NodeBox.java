...
public class NodeBox extends Box {
    ...
    public static <T extends Box> T[] findAllPath(Box box, Class<T> cls, String[] strArr) {
        ...
        return linkedList.toArray((Box[]) Array.newInstance((Class<?>) cls, 0));
    }
    ...
    public static <T extends Box> T[] findDeep(Box box, Class<T> cls, String str) {
        ...
        return arrayList.toArray((Box[]) Array.newInstance((Class<?>) cls, 0));
    }
    ...
    public void dump(StringBuilder sb) {
        sb.append("{\"tag\":\"" + ((Box) this).header.getFourcc() + "\",");
        sb.append("\"boxes\": [");
        dumpBoxes(sb);
        sb.append("]");
        sb.append("}");
