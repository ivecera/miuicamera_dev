...
public class AudioSampleEntry extends SampleEntry {
    ...
    public static AudioSampleEntry createAudioSampleEntry(Header header, short s, short s2, short s3, int i, short s4, int i2, int i3, int i4, int i5, int i6, int i7, int i8, short s5) {
        ...
        ((SampleEntry) audioSampleEntry).drefInd = s;
    ...
    public ByteOrder getEndian() {
        ...
        return endianBox == null ? "twos".equals(((Box) this).header.getFourcc()) ? ByteOrder.BIG_ENDIAN : "lpcm".equals(((Box) this).header.getFourcc()) ? (this.lpcmFlags & kAudioFormatFlagIsBigEndian) != 0 ? ByteOrder.BIG_ENDIAN : ByteOrder.LITTLE_ENDIAN : "sowt".equals(((Box) this).header.getFourcc()) ? ByteOrder.LITTLE_ENDIAN : ByteOrder.BIG_ENDIAN : endianBox.getEndian();
    }
    ...
    public boolean isFloat() {
        return "fl32".equals(((Box) this).header.getFourcc()) || "fl64".equals(((Box) this).header.getFourcc()) || ("lpcm".equals(((Box) this).header.getFourcc()) && (this.lpcmFlags & kAudioFormatFlagIsFloat) != 0);
    }

    public boolean isPCM() {
        return pcms.contains(((Box) this).header.getFourcc());
    }
